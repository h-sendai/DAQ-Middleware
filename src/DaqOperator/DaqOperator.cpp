...
int DaqOperator::comp_stop_procedure(SetCompData *scd)
{
    m_com_completed = false;
    
    try {
        for (int i = 0; i < m_comp_num; i++) {
            if (scd->err_occur[i] == true) {
...
int DaqOperator::comp_restart_procedure(SetCompData *scd)
{
    m_com_completed = false;
