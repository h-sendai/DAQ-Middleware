...
const std::string SampleMonitor::CONDITION_FILE = "./condition.json";
...
int SampleMonitor::daq_start()
{
    ...
    m_hist = new TH1F("hist", "hist",
                m_monitorParam.hist_bin,
                m_monitorParam.hist_min,
                m_monitorParam.hist_max);
...
int SampleMonitor::daq_run()
{
    ...
    if (m_monitorParam.monitor_update_rate == 0) {
        m_monitorParam.monitor_update_rate = 1000;
    }

    unsigned long sequence_num = get_sequence_num();
    if ((sequence_num % m_monitorParam.monitor_update_rate) == 0) {
        m_hist->Draw();
        m_canvas->Update();
    }
    /////////////////////////////////////////////////////////////
