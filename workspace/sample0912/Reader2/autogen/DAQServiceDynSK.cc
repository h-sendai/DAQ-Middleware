...
static const char* _0RL_enumMember_DAQLifeCycleState[] = { "LOADED", "CONFIGURED", "RUNNING", "PAUSED", "ERROR", "STOP" };
static CORBA::TypeCode_ptr _0RL_tc_DAQLifeCycleState = CORBA::TypeCode::PR_enum_tc("IDL:DAQLifeCycleState:1.0", "DAQLifeCycleState", _0RL_enumMember_DAQLifeCycleState, 6, &_0RL_tcTrack);
const CORBA::TypeCode_ptr _tc_DAQLifeCycleState = _0RL_tc_DAQLifeCycleState;

static const char* _0RL_enumMember_DAQCommand[] = { "CMD_CONFIGURE", "CMD_START", "CMD_STOP", "CMD_UNCONFIGURE", "CMD_PAUSE", "CMD_RESUME", "CMD_FIX", "CMD_NOP" };
