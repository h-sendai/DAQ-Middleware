...
enum DAQLifeCycleState { LOADED, CONFIGURED, RUNNING, PAUSED, ERROR, STOP /*, __max_DAQLifeCycleState=0xffffffff */ };
...
enum DAQCommand { CMD_CONFIGURE, CMD_START, CMD_STOP, CMD_UNCONFIGURE, CMD_PAUSE, CMD_RESUME, CMD_FIX, CMD_NOP /*, __max_DAQCommand=0xffffffff */ };
...
enum CompStatus { COMP_WORKING, COMP_FINISHED, COMP_WARNING, COMP_FATAL, COMP_FIXWAIT /*, __max_CompStatus=0xffffffff */ };
